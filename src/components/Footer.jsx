  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left mt-20">
    ...
    >
      ...
      <div className="flex space-x-4">
        {["pinterest-p", "instagram", "twitter", "facebook-f"].map((icon, idx) => (
          <motion.a
            key={idx}
            href="#"
      ...
      <div className="foot-text font-manrope font-medium  opacity-5 mt-[250px] leading-[250px]">©TVG - {new Date().getFullYear()}</div> 
